...
class CalculationTest(TestCase):
    def test_calculations_correct(self):
        ...
        accurate_data=[
                ...
                [950, -5, -15, -20, 910, 0, 910, 132, 44, '', 74, 523, -3, -8, -11, 501, 73, 24, '', 41],
                [950, -5, -15, -20, 910, -30, 880, 0, 67, 7, 178, 523, -3, -8, -11, 501, -11, 490, 0, 32, 3, 77, 0, 490, 97.90, 0, 0, 550, 490, 0, 1040, 25, 1065, 224, 385, 0, 385]
            ]
